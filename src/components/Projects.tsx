          ...
          {projects.filter(p => !p.featured).map((project, index) => (
            <div key={project.title} className="soft-card p-6 group hover:scale-105 transition-all duration-300">
              ...
              <div className="flex gap-3">
                <a
                  href={project.github}
                  className="flex items-center gap-1 text-gray-600 hover:text-purple-600 transition-colors duration-200"
                >
                  <Github size={16} />
                ...
                <a
                  href={project.live}
                  className="flex items-center gap-1 text-gray-600 hover:text-pink-600 transition-colors duration-200"
                >
